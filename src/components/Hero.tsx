...
export const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap banner-section">
        <div className="flex items-center w-full lg:w-1/2 section-left">
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2 section-right">
          <div className="">
            <Image
              src={heroImg}
              width="616"
